...
class SalaryUI:
    def display(self, df_builder):
        ...
        if st.sidebar.button("Add Salary"):
            df_builder.financial_entry.add_salary_entry(new_gross_income, new_pension_contribution_percent,
...
class ExpensesUI:
    def display(self, df_builder):
        ...
        if st.sidebar.button("Add Expense"):
            df_builder.financial_entry.add_expense_entry(new_monthly_expense, new_expense_num_months)
            st.session_state.df = df_builder.rebuild_dataframe()
...
class HousingUI:
    def display(self, df_builder):
        ...
        if st.sidebar.button("Add House"):
            df_builder.financial_entry.add_housing_entry(new_house_name, new_house_value, new_month_acquisition,
